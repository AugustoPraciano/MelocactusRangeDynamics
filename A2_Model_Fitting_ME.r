...
mx <- maxent(trainData, 
             pb,
			 path = "C:/Mbahiensis/Maxent/output",
...
maxResults[[w]] <- read.csv("C:/Mbahiensis/Maxent/output/maxentResults.csv") 
# models tranfers
...
write.csv(x = auc, file = "C:/Mbahiensis/Maxent/testAucValues.csv")

# threshold values are exported as .asc file
write.csv(x = mst, file = "C:/Mbahiensis/Maxent/msthresholdValues.csv")

# Maxent results are exported as .asc file
write.csv(x = maxentResults, file = "C:/Mbahiensis/Maxent/maxentResults.csv")
...
writeRaster(m,
            filename  = "C:/Mbahiensis/Maxent/current_ME.asc",
            format    = 'ascii',
            NAflag    = -9999,
            overwrite = TRUE)
			
writeRaster(presAbsc,
            filename  = "C:/Mbahiensis/Maxent/current_ME_pa.asc",
            format    = 'ascii',
            NAflag    = -9999,
            overwrite = TRUE)			
...
writeRaster(m1,
            filename  = "C:/Mbahiensis/Maxent/2050_SSP245_ME.asc",
            format    = 'ascii',
            NAflag    = -9999,
            overwrite = TRUE)
			
writeRaster(presAbsc1,
            filename  = "C:/Mbahiensis/Maxent/2050_SSP245_ME_pa.asc",
            format    = 'ascii',
            NAflag    = -9999,
            overwrite = TRUE)	
...
writeRaster(m2,
            filename  = "C:/Mbahiensis/Maxent/2050_SSP585_ME.asc",
            format    = 'ascii',
            NAflag    = -9999,
            overwrite = TRUE)		
			
writeRaster(presAbsc2,
            filename  = "C:/Mbahiensis/Maxent/2050_SSP585_ME_pa.asc",
            format    = 'ascii',
            NAflag    = -9999,
            overwrite = TRUE)	
...
writeRaster(m3,
            filename  = "C:/Mbahiensis/Maxent/2070_SSP245_ME.asc",
            format    = 'ascii',
            NAflag    = -9999,
            overwrite = TRUE)	
			
writeRaster(presAbsc3,
            filename  = "C:/Mbahiensis/Maxent/2070_SSP245_ME_pa.asc",
            format    = 'ascii',
            NAflag    = -9999,
            overwrite = TRUE)	
...
writeRaster(m4,
            filename  = "C:/Mbahiensis/Maxent/2070_SSP585_ME.asc",
            format    = 'ascii',
            NAflag    = -9999,
            overwrite = TRUE)	
			
writeRaster(presAbsc4,
            filename  = "C:/Mbahiensis/Maxent/2070_SSP585_ME_pa.asc",
            format    = 'ascii',
            NAflag    = -9999,
            overwrite = TRUE)			
