...
files <- list.files(path=paste('C:/Mbahiensis/Layers', sep=''), 
...
# finds all the files with extension "asc" in the directory 
files1 <- list.files(path=paste('C:/Mbahiensis/Layers_1', sep=''), 
pattern='asc', full.names=TRUE)
...
# finds all the files with extension "asc" in the directory
files2 <- list.files(path=paste('C:/Mbahiensis/Layers_2', sep=''), 
pattern='asc', full.names=TRUE)
...
# finds all the files with extension "asc" in the directory
files3 <- list.files(path=paste('C:/Mbahiensis/Layers_3', sep=''), 
pattern='asc', full.names=TRUE)
...
# finds all the files with extension "asc" in the directory
files4 <- list.files(path=paste('C:/Mbahiensis/Layers_4', sep=''), 
pattern='asc', full.names=TRUE)
...
file <- paste("C:/Mbahiensis/M_bahiensis.csv", sep="")
bahiensis <- read.table(file, header=TRUE, sep=',')
# we do not need the first column
bahiensis <- bahiensis[,-1]
# extract values of the predictors at the presence points
presValues <- extract(predictors, bahiensis)
# first layer of the RasterStack
plot(predictors, 1)
points(bahiensis, col='red', pch='+')

################################# Absences Data #######################################

# Define a mask layer for absence sampling
abscMask <- raster("C:/Mbahiensis/abscense_mask_bahiensis.asc")
...
bahiensis.tc2.lr002 <- gbm.step(data=train.data,
gbm.x = 2:9,
gbm.y = 1,
family = "bernoulli",
tree.complexity = 2,
...
preds <- predict.gbm(bahiensis.tc2.lr002, test.data, 
n.trees=bahiensis.tc2.lr002$gbm.call$best.trees, type="response")
...
varCon[[w]] <- bahiensis.tc2.lr002$contributions

# models tranfers
brt[[w]] <- predict(predictors, bahiensis.tc2.lr002, 
n.trees=bahiensis.tc2.lr002$gbm.call$best.trees, type="response")# current 
brt1[[w]] <- predict(transfer1, bahiensis.tc2.lr002, 
n.trees=bahiensis.tc2.lr002$gbm.call$best.trees, type="response")# SSP 245 for 2050 
brt2[[w]] <- predict(transfer2, bahiensis.tc2.lr002, 
n.trees=bahiensis.tc2.lr002$gbm.call$best.trees, type="response")# SSP 585 for 2050 
brt3[[w]] <- predict(transfer3, bahiensis.tc2.lr002, 
n.trees=bahiensis.tc2.lr002$gbm.call$best.trees, type="response")# SSP 245 for 2070 
brt4[[w]] <- predict(transfer4, bahiensis.tc2.lr002, 
n.trees=bahiensis.tc2.lr002$gbm.call$best.trees, type="response")# SSP 585 for 2070 
}
...
write.csv(x = auc, file = "C:/Mbahiensis/BRT/testAucValues.csv")

# threshold values are exported as .asc file
write.csv(x = mst, file = "C:/Mbahiensis/BRT/msthresholdValues.csv")

# Variables contributions values are exported as .asc file
write.csv(x = varContributions, file = "C:/Mbahiensis/BRT/variables_contributions.csv")
...
writeRaster(m,
            filename  = "C:/Mbahiensis/BRT/current_BRT.asc",
            format    = 'ascii',
            NAflag    = -9999,
            overwrite = TRUE)	
			
writeRaster(presAbsc,
            filename  = "C:/Mbahiensis/BRT/current_BRT_pa.asc",
            format    = 'ascii',
            NAflag    = -9999,
            overwrite = TRUE)	
...
writeRaster(m1,
            filename  = "C:/Mbahiensis/BRT/2050_SSP245_BRT.asc",
            format    = 'ascii',
            NAflag    = -9999,
            overwrite = TRUE)	
			
writeRaster(presAbsc1,
            filename  = "C:/Mbahiensis/BRT/2050_SSP245_BRT_pa.asc",
            format    = 'ascii',
            NAflag    = -9999,
            overwrite = TRUE)	
...
writeRaster(m2,
            filename  = "C:/Mbahiensis/BRT/2050_SSP585_BRT.asc",
            format    = 'ascii',
            NAflag    = -9999,
            overwrite = TRUE)
			
writeRaster(presAbsc2,
            filename  = "C:/Mbahiensis/BRT/2050_SSP585_BRT_pa.asc",
            format    = 'ascii',
            NAflag    = -9999,
            overwrite = TRUE)	
...
writeRaster(m3,
            filename  = "C:/Mbahiensis/BRT/2070_SSP245_BRT.asc",
            format    = 'ascii',
            NAflag    = -9999,
            overwrite = TRUE)	
			
writeRaster(presAbsc3,
            filename  = "C:/Mbahiensis/BRT/2070_SSP245_BRT_pa.asc",
            format    = 'ascii',
            NAflag    = -9999,
            overwrite = TRUE)	
...
writeRaster(m4,
            filename  = "C:/Mbahiensis/BRT/2070_SSP585_BRT.asc",
            format    = 'ascii',
            NAflag    = -9999,
            overwrite = TRUE)	
			
writeRaster(presAbsc4,
            filename  = "C:/Mbahiensis/BRT/2070_SSP585_BRT_pa.asc",
            format    = 'ascii',
            NAflag    = -9999,
            overwrite = TRUE)	
